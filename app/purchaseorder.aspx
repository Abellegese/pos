<%@ Page Title="" Language="C#" MasterPageFile="~/app/app.Master" AutoEventWireup="true" CodeBehind="purchaseorder.aspx.cs" Inherits="pos.app.purchaseorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid pl-3 pr-3" style="position: absolute;" id="container" runat="server">
        ...
        <div class="row">
            <div class="col">
                                    ...
                                    <itemtemplate>
                                        <tr class="border-bottom">
                                            ...
                                            <td>
                                                ...
                                                <a class=" text-primary  " href="purchaseorder.aspx?pono=<%# Eval("order_number")%>"><span>SO#-00000<%# Eval("order_number")%></span></a>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div id="Body1" runat="server">
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    <span class="small" style="height: 100px; color: black" contenteditable="true">From: </span><span style="height: 100px; color: black" contenteditable="true" class=" text-primary small" id="Name" runat="server"></span>
                                                                    <br />
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <table class="table align-items-center table-bordered table-sm " style="color: black;">
                                                                <thead class="thead-dark ">
                                                                    <tr>
                                                                        ...
                                                                        <th scope="col" class="small text-right">Amount</th>
                            ...
                            <main role="main" id="main" class="mt-2 pl-5 pr-5 mb-5" runat="server" visible="false">
                                ...
                                <div class="starter-template">
                                    <center>
                                        ...
                                        <h3 class="text-gray-900 mb-2 font-weight-bold">Create Purchase Order</h3>

                                        <h6 class="text-gray-500 mb-3">By creating purchase order you can easily convert to bill with one click!</h6>
                                        <button type="button" data-toggle="modal" data-target="#ModalCreatePurchaseOrder" class="btn btn-danger text-white"><span class="fas fa-plus mr-2 text-white"></span>Create New Order</button>
                                    </center>
                                </div>
                ...
                <div class="modal fade" data-backdrop="static" id="ModalCreatePurchaseOrder" tabindex="-1" role="dialog" aria-labelledby="ModalAnalysis" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title font-weight-bold text-gray-900" id="exampleModalLabelG"><span class="fas fa-cart-plus mr-2" style="color: #c24599"></span>
                                    Create Purchase Order [PO-00000<span id="orderSpan" runat="server"></span>]
                            
                            <button class="btn btn-circle btn-sm ml-2" type="button" data-toggle="modal" data-target="#ExistingVendorModal"><span class="fas fa-user-check " data-toggle="tooltip" title="Select existing customer" style="color: #d46fe8"></span></button>
                                </h6>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div id="itemInfoDiv" style="display: none">
                                            <button class="btn btn-light btn-sm" type="button" data-toggle="tooltip" onclick="AddTable();CreatePurchaseOrderClient();" title="Add item"><span class="fas fa-plus"></span></button>
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:LinkButton ID="btnCreatePurchaseOrder" runat="server" class="btn btn-sm text-white" Style="background-color: #d46fe8" CausesValidation="false" OnClick="btnCreatePurchaseOrder_Click"><span class="fas fa-plus mr-2"></span>Create Order</asp:LinkButton>
    ...
    <script type="text/javascript">
        function CreatePurchaseOrderClient() {
            PageMethods.CreatePurchaseOrder($("[id*=txtVendorName]").val(), $("#ddlItemName option:selected").text(), $("[id*=txtDate]").val(),
    ...
    <script type="text/javascript">
        ...
        function Success(result) {
            ...
            $('#ModalCreatePurchaseOrder').modal('show');
        }
